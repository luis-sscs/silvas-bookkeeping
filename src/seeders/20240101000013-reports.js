    ...
    const reports = [
      {
        ...
        type: 'invoice',
        reportData: JSON.stringify({ totalInvoices: 45, totalAmount: randomAmount(50000, 100000) }),
        generatedBy: 'admin',
      ...
      },
      {
        ...
        type: 'expense',
        reportData: JSON.stringify({ totalExpenses: 15000, byCategory: { travel: 5000, supplies: 4000, utilities: 6000 } }),
        generatedBy: 'admin',
        generatedDate: randomDate(new Date(2024, 0, 1), new Date()),
        startDate: new Date(2024, 0, 1),
        endDate: new Date(2024, 0, 31),
      ...
      },
      {
        ...
        type: 'customer',
        reportData: JSON.stringify({ newCustomers: 12, activeCustomers: 85, retention: 0.92 }),
        generatedBy: 'admin',
        generatedDate: randomDate(new Date(2024, 0, 1), new Date()),
        startDate: new Date(2024, 0, 1),
        endDate: new Date(2024, 0, 31),
      ...
      },
      {
        ...
        type: 'income',
        reportData: JSON.stringify({ totalRevenue: 150000, sources: { invoices: 120000, services: 30000 } }),
        generatedBy: 'admin',
        generatedDate: randomDate(new Date(2024, 0, 1), new Date()),
        startDate: new Date(2024, 0, 1),
        endDate: new Date(2024, 0, 31),
      ...
      },
      {
        ...
        type: 'product',
        reportData: JSON.stringify({ totalProducts: 50, activeProducts: 45, outOfStock: 5 }),
        generatedBy: 'admin',
        generatedDate: randomDate(new Date(2024, 0, 1), new Date()),
        startDate: new Date(2024, 0, 1),
        endDate: new Date(2024, 0, 31),
